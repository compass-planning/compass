...
export default function App() {
  ...
  // In the consumer app there's no client picker — profile is always loaded
  // selectClient kept as a no-op alias so existing child components compile
  function selectClient(c: Client) { setClient(c); }
